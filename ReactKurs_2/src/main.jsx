...
ReactDOM.createRoot(document.getElementById("root")).render(
  <div >
    <h2>Restaurant: <span text-color="blue">{restaurants[0].name}</span></h2>
    <h3>MENU</h3>
    <ul>
      <li>
   ...
   <br />
   <h2>Restaurant: <b>{restaurants[1].name}</b></h2>
   <h3>MENU</h3>
    <ul>
      <li>
   ...
   <br />
   <h2>Restaurant: <b>{restaurants[2].name}</b></h2>
    <h3>MENU</h3>
    <ul>
      <li>
   ...
   <br />
   <h2>Restaurant: {restaurants[3].name}</h2>
   <h3>MENU</h3>
    <ul>
      <li>
